%% This is copied verbatim from https://raw.github.com/basho/lager/master/src/lager_trunc_io.erl
%% All credit/copyright/etc in relation to this file should be assigned to the lager project.
%%
