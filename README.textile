...
1. Sign up for "Airbrake":http://airbrakeapp.com/
...
2. Start the erlbrake application, replacing the API key with your own:

<pre><code>ERL_LIBS="path/to/ibrowse:path/to/erlbrake:$ERL_LIBS" erl -erlbrake apikey '"76fdb93ab2cf276ec080671a8b3d3866"' -erlbrake error_logger true -erlbrake environment '"development"' -s erlbrake start</code></pre>
