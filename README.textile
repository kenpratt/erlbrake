...
5. Compile erlhoptoad: @cd path/to/erlhoptoad/ && make@
6. Add the erlhoptoad ebin directory to your Erlang path: @-pa path/to/erlhoptoad/ebin@
7. Start ibrowse during your application startup: @application:start(ibrowse)@
8. Test it out!
